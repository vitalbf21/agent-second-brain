...
Ты пишешь боту в Telegram. Голосовые, текст, фото, файлы, пересланные посты - как удобно. Не думаешь про категории, теги или куда что положить.
...
| Пересланный пост или фото доски | Сохраняет файл в хранилище, агент сам читает его и раскладывает суть |
...
```
vault/
├── daily/              # Дневные записи (голосовые, текст, вложения)
...
| **migrate-doctor** | Диагностирует и чинит сломанные обновления с прошлых версий |
